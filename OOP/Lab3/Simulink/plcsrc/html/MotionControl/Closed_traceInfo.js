function RTW_Sid2UrlHash() {
	...
	/* <S1>/Constant */
	this.urlHashMap["MotionControl:39"] = "MotionControl.st:48";
	/* <S1>/Predefined Saturation */
	this.urlHashMap["MotionControl:36"] = "MotionControl.st:38,44";
	/* <S1>/Product */
	this.urlHashMap["MotionControl:34"] = "MotionControl.st:36";
	/* <S1>/Sum */
	this.urlHashMap["MotionControl:33"] = "MotionControl.st:34";
	/* <S1>/Switch */
	this.urlHashMap["MotionControl:37"] = "MotionControl.st:45,51";
	/* <S1>/Ctrl_signal_Pos */
